(window['webpackJsonp'] = window['webpackJsonp'] || []).push([
  [19, 4],
  {
    ...
    EDpe: function (e, t, n) {
      ...
      N.displayName = 'CopyOutlined';
      var w = f['forwardRef'](N),
        S = n('jzin'),
        K = {
          icon: {
            tag: 'svg',
      ...
      t['default'] = (e) => {
        var t = Object(m['c'])('@@initialState'),
          ...
          E = x[0],
          k = x[1],
          N = Object(f['useState'])({ current: 1, pageSize: 10, total: 0 }),
          K = Object(i['a'])(N, 2),
          P = K[0],
          I = K[1],
          L = Object(f['useState'])([]),
