  ...
  [34],
  {
    'Lv+2': function (e, s, A) {
      ...
      var t = A('hYtp'),
        ...
        r = A('q5+0'),
        i = A('ikfJ'),
        a = ['/user/regist', '/user/forget'];
      s['default'] = (e) => {
        var s = Object(r['g'])(),
          t = s.location.pathname;
    ...
    hYtp: function (e, s, A) {
      e.exports = {
        header: 'header___14y8g',
        left: 'left___3O9SQ',
        right: 'right___27Zzv',
        userContent: 'userContent___2yWFA',
      };
    },
  },
]);
